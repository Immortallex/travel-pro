...
function Education() {
  ...
  const [subSpec, setSubSpec] = useState('Undergrad');
  ...
  return (
    ...
    >
      <div className="text-center space-y-8">
        <h1 className="text-5xl font-bold text-blue-900">Education Travel Solutions</h1>
        <p className="text-xl text-gray-700 max-w-3xl mx-auto">
          Student visas, study abroad programs, university tours.
        </p>
        <img
      ...
      <div className="grid md:grid-cols-2 gap-12 mt-16">
        <div className="card p-6">
          <h3 className="text-xl font-semibold">Student Visas</h3>
          <p>F-1, J-1 support for US/UK.</p>
        </div>
        <div className="card p-6">
          <h3 className="text-xl font-semibold">Programs</h3>
          <p>Exchange trips to Harvard or Oxford.</p>
        </div>
      </div>
    </motion.div>
  );
